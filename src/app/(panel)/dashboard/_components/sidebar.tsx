...
export function SidebarDashboard({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex min-h-screen w-full">
            <aside
                className={clsx(
                    'flex flex-col border-r bg-background transition-all duration-300p-4 h-full px-4',
                    {
                        'w-20': isCollapsed,
                        'w-64': !isCollapsed,
            ...
            >
                ...
                <Button
                    className="bg-gray-100 hover:bg-gray-400 text-zinc-900 self-end"
                    onClick={() => setIsCollapsed(!isCollapsed)}
                >
                    {!isCollapsed ? (
                        <ChevronLeft className="w-12 h-12"></ChevronLeft>
                    ) : (
                        <ChevronRight className="w-12 h-12"></ChevronRight>
                    )}
                </Button>
                {isCollapsed && (
            ...
            >
                <header className="md:hidden flex items-center justify-between border-b px-2 md:px-6 h-14 z-10 sticky top-0 bg-white">
                    <Sheet>
                        ...
                        <SheetContent
                            side="left"
                            className="sm:max-w-xs text-black px-6 py-3"
                        >
                            <SheetTitle>VetCookie</SheetTitle>
                            <SheetDescription>
                                Menu adminsatritivo
                            </SheetDescription>
